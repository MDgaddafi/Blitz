...
import btnBg8 from "../../assets/whitebgnew.png";
        ...
        <div className="bg-cover relative mx-auto bg-center">
          <div className="py-36 md:py-24 max-sm:py-16 mx-auto items-center justify-center flex">
            <div className="max-sm:w-[90%] md:w-[90%] mx-auto">
              <h2 className="text-center mt-16 mb-8 max-sm:mb-4 text-[#CFFF55] font-grotters text-2xl md:text-3xl -skew-y-6 max-sm:-skew-y-2">
              ...
              <div className="lg:w-[850px] md:w-[90%] max-sm:w-[100%] mx-auto">
                <p className="mx-auto h-[200px] md:mt-10 leading-[24px] inline-block text-[18px] max-sm:text-[14px] text-center my-6">
                  {" "}
              ...
              <div>
                ...
                <div className="w-[500px] max-sm:w-[100%] mx-auto">
                  <p className="mx-auto md:mt-5 md:mb-20 lg:mb-24 max-sm:mt-2 max-sm:mb-16 leading-[24px] text-[18px] max-sm:text-[14px] text-center ">
